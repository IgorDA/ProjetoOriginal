...
<div class="container">
	<p>&nbsp;</p>
	<h3 class="text-center">Cadastro funcionario</h3>
	<hr />
	<p>&nbsp;</p>
</div>
...
<div class="container">
	...
	<form method="POST" action="inserirfunc.php">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" name="cargo" id="inputAddress" placeholder="Seu cargo">
	  </div>
	  <a href="inserirfunc.php"><button type="submit" class="btn btn-primary">Cadastrar</button></a>
	</form>
	<p>&nbsp;</p>
